...
def train(ctx):
    ...
    for fold in range(1, 4 + 1):
        ...
        MODEL_NAME = "model_v32_multiclass"
...
def create_model(pretrained_weights=None,
    ...
    layer1 = Conv2D(
        12, 3, padding='same', kernel_initializer='he_normal')(input1)
    ...
    layer3 = Conv2D(
        24, 3, padding='same', kernel_initializer='he_normal')(layer2)
    if batch_normalization:
    ...
    layer5 = Conv2D(
        48, 3, padding='same', kernel_initializer='he_normal')(layer4)
    if batch_normalization:
    ...
    layer7 = Conv2D(
        64, 3, padding='same', kernel_initializer='he_normal')(layer6)
    if batch_normalization:
    ...
    layer9 = Conv2D(
        128, 1, padding='same', kernel_initializer='he_normal')(layer8)
    if batch_normalization:
    ...
    layer11 = Conv2D(
        64, 3, padding='same', kernel_initializer='he_normal')(layer10)
    if batch_normalization:
    ...
    layer13 = Conv2D(
        48, 3, padding='same', kernel_initializer='he_normal')(layer12)
    if batch_normalization:
    ...
    layer15 = Conv2D(
        24, 3, padding='same', kernel_initializer='he_normal')(layer14)
    if batch_normalization:
    ...
    layer17 = Conv2D(
        12, 3, padding='same', kernel_initializer='he_normal')(layer16)
    if batch_normalization:
