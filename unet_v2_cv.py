...
def train(ctx):
    ...
    for fold in range(1, 4 + 1):
        ...
        new_weights_file = "unet_v2_best.hdf5"
...
def create_model(
    ...
    conv1 = Conv2D(
        6, 3, activation="relu", padding="same", kernel_initializer="he_normal"
    )(inputs)
    conv1 = Conv2D(
        6, 3, activation="relu", padding="same", kernel_initializer="he_normal"
    )(conv1)
    ...
    conv2 = Conv2D(
        12, 3, activation="relu", padding="same", kernel_initializer="he_normal"
    )(pool1)
    conv2 = Conv2D(
        12, 3, activation="relu", padding="same", kernel_initializer="he_normal"
    )(conv2)
    ...
    up8 = Conv2D(
        12, 2, activation="relu", padding="same", kernel_initializer="he_normal"
    ...
    up9 = Conv2D(
        6, 2, activation="relu", padding="same", kernel_initializer="he_normal"
