...
def train(ctx):
    for loo in range(1, 16 + 1):
        ...
        MODEL_NAME = "model_v22_multiclass"
...
def create_model(
    ...
    input1, model_v12 = create_structure(input1_size, "input1")
    input2, model_v15 = create_structure(input2_size, "input2")

    concatenated_layer = Concatenate()([model_v12, model_v15])
    ...
    model = Model(inputs=[input1, input2], outputs=[output1, output_iris])
