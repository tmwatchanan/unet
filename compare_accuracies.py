...
def write_compared_accuracies():
    ...
    v26_experiment_name = (
        "eye_v3-s5-model_v27_multiclass-softmax-cce-lw_1_0.01-hsv-loo_{0}-lr_1e_2-bn"
    )
    acc_csv_filename = f"model_v12_v15_v27.csv"
    output_rows = []
    for fold in range(1, 16 + 1):
        ...
        STEP_SIZE = 100
        for epoch in range(499, 5000, STEP_SIZE):
            output_row = []
    ...
    csv_dir = os.path.join("data", "comparison")
