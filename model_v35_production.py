...
def train(ctx):
    ...
    MODEL_NAME = "model_v35_multiclass"
    MODEL_INFO = f"softmax-cce-lw_1_0-{COLOR_MODEL}-production"
...
def create_model(pretrained_weights=None,
    ...
    layer1 = Conv2D(
        24, 3, padding='same', kernel_initializer='he_normal')(input1)
    ...
    layer3 = Conv2D(
        48, 3, padding='same', kernel_initializer='he_normal')(layer2)
    if batch_normalization:
    ...
    layer5 = Conv2D(
        96, 3, padding='same', kernel_initializer='he_normal')(layer4)
    if batch_normalization:
    ...
    layer7 = Conv2D(
        128, 3, padding='same', kernel_initializer='he_normal')(layer6)
    if batch_normalization:
    ...
    layer9 = Conv2D(
        256, 1, padding='same', kernel_initializer='he_normal')(layer8)
    if batch_normalization:
    ...
    layer11 = Conv2D(
        128, 3, padding='same', kernel_initializer='he_normal')(layer10)
    if batch_normalization:
    ...
    layer13 = Conv2D(
        96, 3, padding='same', kernel_initializer='he_normal')(layer12)
    if batch_normalization:
    ...
    layer15 = Conv2D(
        48, 3, padding='same', kernel_initializer='he_normal')(layer14)
    if batch_normalization:
    ...
    layer17 = Conv2D(
        24, 3, padding='same', kernel_initializer='he_normal')(layer16)
    if batch_normalization:
...
def evaluate(ctx):
    ...
    epoch = training_validation_evaluation['epoch']
    ...
    ordered_training_validation_evaluation.append(format_accuracy(training_validation_evaluation["training"]))
    ordered_training_validation_evaluation.append(format_accuracy(training_validation_evaluation["validation"]))
    ordered_training_validation_evaluation.append(format_accuracy(training_validation_evaluation["test"]))
    ordered_training_validation_evaluation.append(training_validation_evaluation["epoch"])
...
def evaluate_training_and_validation(experiment_name):
    data_dir = "data"
    ...
    print(f"max accuracy @ epoch # {max_val_output1_acc_epoch}")
