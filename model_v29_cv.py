...
def train(ctx):
    ...
    for fold in range(1, 4 + 1):
        ...
        MODEL_NAME = "model_v29_multiclass"
...
def preprocess_images_in_batch(img_batch, segment1_batch, segment2_batch, img_color_model):
    ...
    for (img, segment1, segment2) in zip(img_batch, segment1_batch, segment2_batch):
        ...
        blob_segment1 = segment_blob_size(segment1.copy())
        blob_segment2 = segment_blob_size(segment2.copy())
        dt_segment1 = preprocess_segment_input(segment1.copy())
        dt_segment2 = preprocess_segment_input(segment2.copy())
        processed_input = np.concatenate((processed_img, blob_segment1, blob_segment2, dt_segment1, dt_segment2), axis=-1)
...
def get_test_data(
    test_path, image_folder="images",segment_folder='segments', target_size=(256, 256), image_color="rgb", seed=1
):
